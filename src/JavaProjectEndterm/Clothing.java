...
public class Clothing extends javax.swing.JFrame {
    ...
    JavaProjectEndterm.Components com= new JavaProjectEndterm.Components();
        ...
        try {
           ...
           DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
              ...
              for(int i = 0; i < tableLines.length; i++)
            {
                ...
                boolean found;
                String cat=new String("Clothings");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        JavaProjectEndterm.HomePage hhh= new JavaProjectEndterm.HomePage();
        hhh.setVisible(true);
        this.dispose();
